...
public class ActiveStandbyElector implements StatCallback, StringCallback {
     ...
     *
     * @param zookeeperHostPorts ZooKeeper hostPort for all ZooKeeper servers
     * @param zookeeperSessionTimeout ZooKeeper session timeout
     * @param parentZnodeName znode under which to create the lock
     * @param acl ZooKeeper ACL's
     * @param authInfo a list of authentication credentials to add to the ZK connection
     * @param app reference to callback interface object
     * @throws IOException
     ...
     * @param authInfo a list of authentication credentials to add to the ZK connection
     * @param app reference to callback interface object
     * @param failFast whether need to add the retry when establishing ZK connection.
     * @throws IOException
     * @throws HadoopIllegalArgumentException
     */
    // TODO: 17/3/24 by zmyer
     ...
     *
     * @param needFence true if the underlying daemon may need to be fenced if a failover occurs due to dropping out of
     * the election.
     */
     ...
     * @throws ActiveNotFoundException when there is no active leader
     * @throws KeeperException other zookeeper operation errors
     * @throws InterruptedException
     * @throws IOException when ZooKeeper connection could not be established
     */
     ...
     *
     * @return the Stat of the breadcrumb node that was read, or null if no breadcrumb node existed
     */
    // TODO: 17/3/24 by zmyer
    ...
    private final class WatcherWithClientRef implements Watcher {
         ...
         * @throws KeeperException if the connection attempt times out. This will be a ZooKeeper ConnectionLoss
         * exception code.
