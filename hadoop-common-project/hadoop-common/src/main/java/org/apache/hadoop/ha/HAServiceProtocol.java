...
public interface HAServiceProtocol {
     ...
     *
     * @throws HealthCheckFailedException if the health check of a service fails.
     * @throws AccessControlException if access is denied.
     * @throws IOException if other errors happen
     */
    @Idempotent
     ...
     *
     * @throws ServiceFailedException if transition from standby to active fails.
     * @throws AccessControlException if access is denied.
     * @throws IOException if other errors happen
     */
    @Idempotent
     ...
     *
     * @throws ServiceFailedException if transition from active to standby fails.
     * @throws AccessControlException if access is denied.
     * @throws IOException if other errors happen
     */
    @Idempotent
