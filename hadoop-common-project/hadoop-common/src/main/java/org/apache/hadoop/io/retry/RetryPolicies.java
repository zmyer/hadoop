...
public class RetryPolicies {
    ...
    static class RetryUpToMaximumCountWithFixedSleep extends RetryLimited {
        // TODO: 17/3/27 by zmyer
        RetryUpToMaximumCountWithFixedSleep(int maxRetries, long sleepTime, TimeUnit timeUnit) {
    ...
    public static class MultipleLinearRandomRetry implements RetryPolicy {
        ...
        // TODO: 17/3/27 by zmyer
        MultipleLinearRandomRetry(List<Pair> pairs) {
         ...
         *
         * @return the corresponding pair, or null if the current number of retry > maximum number of retry.
         */
        // TODO: 17/3/27 by zmyer
    ...
    // TODO: 17/3/27 by zmyer
    private static class OtherThanRemoteExceptionDependentRetry implements RetryPolicy {
        //默认重试对象
        ...
        // TODO: 17/3/27 by zmyer
        OtherThanRemoteExceptionDependentRetry(RetryPolicy defaultPolicy,
    ...
    // TODO: 17/3/27 by zmyer
    private static class ExponentialBackoffRetry extends RetryLimited {
        // TODO: 17/3/27 by zmyer
     ...
     */
    // TODO: 17/3/27 by zmyer
    private static class FailoverOnNetworkExceptionRetry implements RetryPolicy {
        //重试对象
        ...
        /**
         * @return 0 if this is our first failover/retry (i.e., retry immediately), sleep exponentially otherwise
         */
        // TODO: 17/3/27 by zmyer
