...
public class NetworkTopology {
    ...
    static class InnerNode extends NodeBase {
         ...
         * @return null if the node is not found or the childnode is there but not an instance of
         * {@link InnerNode}
         */
     ...
     * @throws IllegalArgumentException if add a node to a leave or node to be added is not a leaf
     */
     ...
     * method.
     *
     * @param node The string representation of this node's network location is used to retrieve a
     * Node object.
    ...
    /**
     * @return true if this cluster has ever consisted of multiple racks, even if it is not now a
     * multi-rack cluster.
     */
     ...
     * @return the distance between node1 and node2 which is zero if they are the same or {@link
     * Integer#MAX_VALUE} if node1 or node2 do not belong to the cluster
     */
     ...
     * @throws IllegalArgumentException when either node1 or node2 is null, or node1 or node2 do not
