...
public class UserGroupInformation {
     ...
     * @param externalKeyTab if the subject's keytab is managed by the user. Setting this to true will prevent UGI from
     * attempting to login the keytab, or to renew it.
     */
     ...
     *
     * @param subject the subject to use when logging in a user, or null to create a new subject.
     * @throws IOException if login fails
     */
    @InterfaceAudience.Public
    @InterfaceStability.Evolving
     ...
     *
     * @throws IOException
     * @throws KerberosAuthException if a failure occurred in logout, or if the user did not log in by invoking
     * loginUserFromKeyTab() before.
     */
    @InterfaceAudience.Public
    @InterfaceStability.Evolving
