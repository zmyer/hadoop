...
public class GenericOptionsParser {
     ...
     *
     * @param files the input files argument
     * @param expandWildcard whether a wildcard entry is allowed and expanded. If true, any directory followed by a
     * wildcard is a valid entry and is replaced with the list of jars in that directory. It is used to support the
     * wildcard notation in a classpath.
     * @return a comma-separated list of validated and qualified paths, or null if the input files argument is null
     */
