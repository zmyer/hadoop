...
public class NameNode extends ReconfigurableBase implements
    ...
    /**
     * @return NameNode HTTPS address, used by the Web UI, image transfer, and HTTP-based file
     * system clients like WebHDFS
     */
    ...
    /**
     * @return NameNodeHttpServer, used by unit tests to ensure a full shutdown, so that no bind
     * exception is thrown during restart.
     */
    @VisibleForTesting
     ...
     *
     * @param conf Configuration object to lookup specific key and to set the value to the key
     * passed. Note the conf object is modified
