...
public interface ApplicationBaseProtocol {
     ...
     * @return report on applications matching the given application types defined in the request
     * @throws YarnException
     * @throws IOException
     ...
     * </ul>
     *
     * @param request request for an application attempt report
     ...
     * </p>
     *
     * @param request request for reports on all application attempts of an application
    ...
    @Idempotent
    // TODO: 17/3/25 by zmyer
    GetApplicationAttemptsResponse getApplicationAttempts(
     ...
     * </p>
     *
     * @param request request for a container report
     ...
     * </p>
     *
     * @param request request for a list of container reports of an application attempt.
