...
public interface ApplicationClientProtocol extends ApplicationBaseProtocol {
     ...
     * @return <code>ResourceManager</code> returns an empty response on success and throws an exception on rejecting
     * the request
     * @throws YarnException
     * @throws IOException
    ...
    @Unstable
    // TODO: 17/3/25 by zmyer
    FailApplicationAttemptResponse failApplicationAttempt(
    ...
    @Idempotent
    // TODO: 17/3/25 by zmyer
    GetClusterNodesResponse getClusterNodes(
    ...
    @Idempotent
    // TODO: 17/3/25 by zmyer
    MoveApplicationAcrossQueuesResponse moveApplicationAcrossQueues(
     ...
     * @return response containing the new <code>ReservationId</code> to be used to submit a new reservation
     ...
     * @throws YarnException if the request is invalid or reservation cannot be created successfully
     * @throws IOException
     */
    @Public
    @Unstable
     ...
     * </p>
     *
     * @param request to update an existing Reservation (the ReservationRequest should refer to an existing valid {@link
     * ReservationId})
    ...
    @Unstable
    // TODO: 17/3/25 by zmyer
    ReservationUpdateResponse updateReservation(
     ...
     * </p>
     *
     * @param request to remove an existing Reservation (the ReservationRequest should refer to an existing valid {@link
     * ReservationId})
    ...
    @Unstable
    // TODO: 17/3/25 by zmyer
    ReservationDeleteResponse deleteReservation(
     ...
     * be returned. Reservation allocations are subject to change in the event of re-planning as described by {@code
    ...
    @Unstable
    // TODO: 17/3/25 by zmyer
    GetLabelsToNodesResponse getLabelsToNodes(
     ...
     * @throws YarnException if update request has empty values or application is in completing states.
     * @throws IOException on IO failures
     */
    @Public
    @Unstable
