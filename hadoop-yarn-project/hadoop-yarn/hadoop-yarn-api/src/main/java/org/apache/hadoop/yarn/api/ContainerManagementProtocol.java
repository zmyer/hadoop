...
public interface ContainerManagementProtocol {
     ...
     * @return response including conatinerIds of all successfully launched containers, a containerId-to-exception map
     * for failed requests and a allServicesMetaData map.
     * @throws YarnException
     * @throws IOException
     * @throws NMNotYetReadyException This exception is thrown when NM starts from scratch but has not yet connected
     * with RM.
     */
    @Public
    @Stable
     ...
     * </p>
     *
     * @param request request to stop a list of containers
     * @return response which includes a list of containerIds of successfully stopped containers, a
     ...
     * </p>
     *
     * @param request request to get <code>ContainerStatus</code>es of containers with the specified
     * <code>ContainerId</code>s
     * @return response containing the list of <code>ContainerStatus</code> of the successfully queried containers and a
     * containerId-to-exception map for failed requests.
     * @throws YarnException
     * @throws IOException
     */
     ...
     * </p>
     *
     * @param request request to increase resource of a list of containers
     * @return response which includes a list of containerIds of containers whose resource has been successfully
     * increased and a containerId-to-exception map for failed requests.
     * @throws YarnException
     * @throws IOException
     */
    @Public
