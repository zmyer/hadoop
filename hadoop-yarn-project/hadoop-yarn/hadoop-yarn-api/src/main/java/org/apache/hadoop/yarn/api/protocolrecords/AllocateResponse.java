...
public abstract class AllocateResponse {
     ...
     *
     * @return <code>AMCommand</code> if the <code>ApplicationMaster</code> should take action, <code>null</code>
     * otherwise
     * @see AMCommand
     */
    @Public
     ...
     * application.
     *
     * @return limit of available headroom for resources in the cluster for the application
     */
    @Public
    @Stable
     ...
     * satisfied due to error.
     *
     * @param updateErrors list of <code>UpdateContainerError</code> for containers updates requests that were in error
     */
    @Public
    @Unstable
    ...
    public static final class AllocateResponseBuilder {
         ...
         *
         * @param allocatedContainers <code>allocatedContainers</code> of the response
         * @return {@link AllocateResponseBuilder}
         ...
         *
         * @param availableResources <code>availableResources</code> of the response
         * @return {@link AllocateResponseBuilder}
         ...
         *
         * @param completedContainersStatuses <code>completedContainersStatuses</code> of the response
         * @return {@link AllocateResponseBuilder}
         ...
         *
         * @param applicationPriority <code>applicationPriority</code> of the response
         * @return {@link AllocateResponseBuilder}
