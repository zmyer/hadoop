...
public abstract class RegisterApplicationMasterResponse {
     ...
     * </p>
     *
     * @return the list of running containers as viewed by <code>ResourceManager</code> from previous application
     * attempts
     ...
     * <code>ResourceManager</code> from previous application attempts.
     *
     * @param containersFromPreviousAttempt the list of running containers as viewed by <code>ResourceManager</code>
     ...
     *
     * @return the list of NMTokens for communicating with the NMs where the containers of previous application attempts
     * are running.
     ...
     * containers of previous application attempts are running.
     *
     * @param nmTokens the list of NMTokens for communicating with the NMs where the containers of previous application
     * attempts are running.
     */
    @Private
    @Unstable
     ...
     *
     * @param types a set of the resource types that the scheduler considers during scheduling
     */
    @Private
    @Unstable
