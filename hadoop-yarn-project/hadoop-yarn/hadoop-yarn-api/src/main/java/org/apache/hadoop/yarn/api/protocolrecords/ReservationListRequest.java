...
public abstract class ReservationListRequest {
     ...
     *
     * @param queue Required. Cannot be null or empty. Refers to the reservable queue in the scheduler that was selected
     * when creating a reservation submission {@link ReservationSubmissionRequest}.
     * @param reservationId Optional. String representation of {@code ReservationId} If provided, other fields will be
     * ignored.
     * @param startTime Optional. If provided, only reservations that end after the startTime will be selected. This
     * defaults to 0 if an invalid number is used.
     * @param endTime Optional. If provided, only reservations that start on or before endTime will be selected. This
     * defaults to Long.MAX_VALUE if an invalid number is used.
     * @param includeReservationAllocations Optional. Flag that determines whether the entire reservation allocations
     * are to be returned. Reservation allocations are subject to change in the event of re-planning as described by
     ...
     * time are ignored.
     *
     * @param endTime Optional. If provided, only reservations that start before endTime will be selected. This defaults
     ...
     * be included in the response.
     *
     * @param includeReservationAllocations Optional. Flag that determines whether the entire list of {@code
     * ResourceAllocationRequest} will be returned.
     */
    @Public
    @Unstable
