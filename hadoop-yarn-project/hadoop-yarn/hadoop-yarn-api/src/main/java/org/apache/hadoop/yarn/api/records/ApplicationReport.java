...
public abstract class ApplicationReport {
     ...
     * </p>
     *
     * @return <em>client token</em> for communicating with the <code>ApplicationMaster</code>
     */
    @Public
    @Stable
     ...
     * errors.
     *
     * @return <em>diagnositic information</em> of the application in case of errors
     */
    @Public
    @Stable
