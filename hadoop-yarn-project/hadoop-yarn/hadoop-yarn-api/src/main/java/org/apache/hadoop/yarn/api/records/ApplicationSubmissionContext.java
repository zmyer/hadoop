...
public abstract class ApplicationSubmissionContext {
     ...
     *
     * @param applicationId <code>ApplicationId</code> of the submitted application
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     * launched.
     *
     * @return <code>ContainerLaunchContext</code> for the <code>ApplicationMaster</code> container
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     * launched.
     *
     * @param amContainer <code>ContainerLaunchContext</code> for the <code>ApplicationMaster</code> container
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     * configuration.
     *
     * @param maxAppAttempts the number of max attempts of the application to be submitted.
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     *
     * @return the resource required by the <code>ApplicationMaster</code> for this application.
     */
    @Public
    // TODO: 17/3/25 by zmyer
     ...
     * application.
     *
     * @param resource the resource required by the <code>ApplicationMaster</code> for this application.
     */
    @Public
    // TODO: 17/3/25 by zmyer
     ...
     * attempts or not.
     *
     * @return the flag which indicates whether to keep containers across application attempts or not.
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     *
     * @param logAggregationContext for the application
     */
    @Public
    @Stable
    // TODO: 17/3/25 by zmyer
     ...
     *
     * @return the reservation id representing the unique id of the corresponding reserved resource allocation in the
     * scheduler
     */
    @Public
    @Unstable
     ...
     * the scheduler (between start and end time of the corresponding reservation)
     *
     * @param reservationID representing the unique id of the corresponding reserved resource allocation in the
     * scheduler
     */
    @Public
    @Unstable
     ...
     * </p>
     *
     * @param applicationTimeouts <code>ApplicationTimeouts</code>s for the application
     */
    @Public
    @Unstable
    // TODO: 17/3/25 by zmyer
