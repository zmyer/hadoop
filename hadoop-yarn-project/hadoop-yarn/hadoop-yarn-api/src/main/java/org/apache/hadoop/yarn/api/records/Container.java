...
public abstract class Container implements Comparable<Container> {
     ...
     * <p>
     *
     * @return the <em>ID</em> corresponding to the original  allocation request which is satisfied by this allocation.
     */
    @Public
    @Evolving
    // TODO: 17/4/3 by zmyer
     ...
     * <p>
     *
     * @param allocationRequestID the <em>ID</em> corresponding to the original allocation request which is satisfied by
     * this allocation.
     */
    @Private
    @Unstable
