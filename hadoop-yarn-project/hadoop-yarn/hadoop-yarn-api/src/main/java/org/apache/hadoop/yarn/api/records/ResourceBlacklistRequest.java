...
public abstract class ResourceBlacklistRequest {
     ...
     *
     * @return list of resource-names which should be added to the application blacklist
     */
    @Public
    @Stable
     ...
     *
     * @param resourceNames list of resource-names which should be added to the application blacklist
     */
    @Public
    @Stable
     ...
     * application blacklist.
     *
     * @return list of resource-names which should be removed from the application blacklist
     */
    @Public
    @Stable
     ...
     * application blacklist.
     *
     * @param resourceNames list of resource-names which should be removed from the application blacklist
     */
    @Public
    @Stable
