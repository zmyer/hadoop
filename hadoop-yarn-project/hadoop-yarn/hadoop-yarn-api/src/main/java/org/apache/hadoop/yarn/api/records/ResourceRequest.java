...
public abstract class ResourceRequest extends AbstractResourceRequest
    ...
    public static ResourceRequest newInstance(Priority priority, String hostName,
        ...
        return ResourceRequest.newBuilder().priority(priority).resourceName(hostName).capability(capability)
    ...
    // TODO: 17/4/3 by zmyer
    public static ResourceRequest newInstance(Priority priority, String hostName,
        Resource capability, int numContainers, boolean relaxLocality, String labelExpression) {
        return ResourceRequest.newBuilder().priority(priority).resourceName(hostName).capability(capability)
    ...
    public static final class ResourceRequestBuilder {
         ...
         *
         * @param nodeLabelExpression <code>nodeLabelExpression</code> of the request
         * @return {@link ResourceRequestBuilder}
         ...
         * @return {@link ResourceRequestBuilder}
         * @see ResourceRequest#setExecutionTypeRequest(ExecutionTypeRequest)
         */
        @Public
        @Evolving
         ...
         *
         * @param allocationRequestId <code>allocationRequestId</code> of the request
         * @return {@link ResourceRequestBuilder}
     ...
     * @return whether the given <em>host/rack</em> string represents an arbitrary host name
     */
    @Public
    @Stable
     ...
     *
     * @return resource (e.g. <em>host/rack</em>) on which the allocation is desired
     */
    @Public
    @Stable
     ...
     *
     * @param resourceName (e.g. <em>host/rack</em>) on which the allocation is desired
     */
    @Public
    @Stable
     ...
     *
     * @param numContainers number of containers required with the given specifications
     */
    @Public
    @Stable
     ...
     *
     * @return whether locality relaxation is enabled with this <code>ResourceRequest</code>.
     */
    @Public
    @Stable
     ...
     *
     * @param execSpec ExecutionTypeRequest of the requested container
     */
    @Public
    @Evolving
     ...
     *
     * @param allocationRequestID the <em>ID</em> corresponding to this allocation request.
     */
    @Public
    @Evolving
