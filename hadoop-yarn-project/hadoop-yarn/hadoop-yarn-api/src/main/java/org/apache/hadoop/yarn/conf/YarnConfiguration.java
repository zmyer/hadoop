...
public class YarnConfiguration extends Configuration {
    ...
    // IPC Configs
    ////////////////////////////////
    private static final String IPC_PREFIX = YARN_PREFIX + "ipc.";
     ...
     *
     * @deprecated Eventually, we want to default to the curator-based implementation and remove the {@link
     * ActiveStandbyElector} based implementation. We should remove this config then.
     */
    @Unstable
    @Deprecated
     ...
     *
     * @deprecated This default value is ignored and will be removed in a future release. The default value of {@code
     * yarn.resourcemanager.state-store.max-completed-applications} is the value of {@link
     ...
     *
     * @param conf the configuration
     * @return whether the timeline service v.2 is enabled. V.2 refers to a version greater than equal to 2 but smaller
     * than 3.
     */
    // TODO: 17/4/3 by zmyer
    public static boolean timelineServiceV2Enabled(Configuration conf) {
        return timelineServiceEnabled(conf) && (int) getTimelineServiceVersion(conf) == 2;
    }
