...
public abstract class YarnClient extends AbstractService {
     ...
     *
     * @param appContext {@link ApplicationSubmissionContext} containing all the details needed to submit a new
     * application
    ...
    public abstract ApplicationId submitApplication(
        ApplicationSubmissionContext appContext) throws YarnException, IOException;
     ...
     * </p>
     *
     * @param applicationAttemptId {@link ApplicationAttemptId} of the attempt to fail.
     * @throws YarnException in case of errors or if YARN rejects the request due to access-control restrictions.
     * @throws IOException
     ...
     * </p>
     *
     * @param applicationId {@link ApplicationId} of the application that needs to be killed
     * @throws YarnException in case of errors or if YARN rejects the request due to access-control restrictions.
     * @throws IOException
     * @see #getQueueAclsInfo()
     */
     ...
     * </ul>
     *
     * @param appId {@link ApplicationId} of the application that needs a report
     ...
     * </p>
     *
     * @param states The {@link NodeState}s to filter on. If no filter states are given, nodes in all states will be
     * returned.
     ...
     *
     * @param renewer Address of the renewer who can renew these tokens when needed by securely talking to YARN.
     * @return a delegation token ({@link Token}) that can be used to talk to YARN
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @param queueName Name of the queue whose information is needed
     ...
     * </p>
     *
     * @param parent Name of the queue whose child-queues' information is needed
     * @return a list of queue-information for all queues who are direct children of the given parent queue.
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @return a list of queue acls ({@link QueueUserACLInfo}) for <em>current user</em>
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @param applicationAttemptId {@link ApplicationAttemptId} of the application attempt that needs a report
     * @return application attempt report
     * @throws YarnException
     * @throws ApplicationAttemptNotFoundException if application attempt not found
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * @return a list of reports for all application attempts for specified application.
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @param containerId {@link ContainerId} of the container that needs a report
     ...
     * @return a list of reports of all containers for specified application attempts
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @param appId Application to move.
     * @param queue Queue to place it in to.
     * @throws YarnException
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
     ...
     * </p>
     *
     * @return The {@link GetNewReservationResponse} containing a new {@link ReservationId} object.
     ...
     * @return response contains the {@link ReservationId} on accepting the submission
     ...
     * </p>
     *
     * @param request to update an existing Reservation (the {@link ReservationUpdateRequest} should refer to an
     * existing valid {@link ReservationId})
     * @return response empty on successfully updating the existing reservation
     * @throws YarnException if the request is invalid or reservation cannot be updated successfully
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
    @Public
     ...
     * </p>
     *
     * @param request to remove an existing Reservation (the {@link ReservationDeleteRequest} should refer to an
     * existing valid {@link ReservationId})
     * @return response empty on successfully deleting the existing reservation
     * @throws YarnException if the request is invalid or reservation cannot be deleted successfully
     * @throws IOException
     */
    // TODO: 17/3/25 by zmyer
    @Public
     ...
     * </p>
     *
     * @param request to list reservations in a plan. Contains fields to select String queue, ReservationId
     * reservationId, long startTime, long endTime, and a bool includeReservationAllocations.
     *
     * queue: Required. Cannot be null or empty. Refers to the reservable queue in the scheduler that was selected when
     * creating a reservation submission {@link ReservationSubmissionRequest}.
     *
     * reservationId: Optional. If provided, other fields will be ignored.
     *
     * startTime: Optional. If provided, only reservations that end after the startTime will be selected. This defaults
     * to 0 if an invalid number is used.
     *
     * endTime: Optional. If provided, only reservations that start on or before endTime will be selected. This defaults
     * to Long.MAX_VALUE if an invalid number is used.
     *
     * includeReservationAllocations: Optional. Flag that determines whether the entire reservation allocations are to
     * be returned. Reservation allocations are subject to change in the event of re-planning as described by {@link
     * ReservationDefinition}.
     * @return response that contains information about reservations that are being searched for.
     ...
     * @throws YarnException when there is a failure in {@link ApplicationClientProtocol}
     * @throws IOException when there is a failure in {@link ApplicationClientProtocol}
     */
    // TODO: 17/3/25 by zmyer
    @Public
    @Unstable
     ...
     * </p>
     *
     * @param containerId {@link ContainerId} of the container that needs to be signaled
