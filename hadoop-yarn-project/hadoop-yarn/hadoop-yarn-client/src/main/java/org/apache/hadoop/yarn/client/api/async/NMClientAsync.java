...
public abstract class NMClientAsync extends AbstractService {
    ...
    /**
     * @deprecated Use {@link #createNMClientAsync(AbstractCallbackHandler)} instead.
     */
    // TODO: 17/3/27 by zmyer
    @Deprecated
    ...
    /**
     * @deprecated Use {@link #NMClientAsync(String, AbstractCallbackHandler)} instead.
     */
    // TODO: 17/3/27 by zmyer
    @Deprecated
    ...
    public abstract static class AbstractCallbackHandler implements CallbackHandler {
         ...
         * @param allServiceResponse a Map between the auxiliary service names and their outputs
         */
        // TODO: 17/3/27 by zmyer
         ...
         */
        // TODO: 17/3/27 by zmyer
        public abstract void onStartContainerError(ContainerId containerId, Throwable t);
         ...
         */
        // TODO: 17/3/27 by zmyer
        public abstract void onGetContainerStatusError(ContainerId containerId, Throwable t);
     ...
     * @deprecated Use {@link NMClientAsync.AbstractCallbackHandler} instead.
     *
     * <p> The callback interface needs to be implemented by {@link NMClientAsync} users. The APIs are called when
     * responses from <code>NodeManager</code> are available. </p>
     *
     * <p> Once a callback happens, the users can chose to act on it in blocking or non-blocking manner. If the action
     * on callback is done in a blocking manner, some of the threads performing requests on NodeManagers may get blocked
     * depending on how many threads in the pool are busy. </p>
     *
     * <p> The implementation of the callback function should not throw the unexpected exception. Otherwise, {@link
     * NMClientAsync} will just catch, log and then ignore it. </p>
     */
    // TODO: 17/3/27 by zmyer
    @Deprecated
