...
public class AMRMClientAsyncImpl<T extends ContainerRequest> extends AMRMClientAsync<T> {
     ...
     */
    // TODO: 17/3/26 by zmyer
    public AMRMClientAsyncImpl(int intervalMs, AbstractCallbackHandler callbackHandler) {
    ...
    /**
     * @deprecated Use {@link #AMRMClientAsyncImpl(int, AMRMClientAsync.AbstractCallbackHandler)} instead.
     */
    // TODO: 17/3/26 by zmyer
    @Deprecated
