...
public class CommonNodeLabelsManager extends AbstractService {
     ...
     *
     * @param labelsToRemove node labels to remove
     * @throws IOException
     */
     ...
     *
     * @param labels set of labels for which labels to nodes mapping will be returned.
     * @return labels to nodes map
     */
     ...
     *
     * @param labels set of nodelabels for which labels to nodes mapping will be returned.
     * @return labels to nodes map
     */
