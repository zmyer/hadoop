...
public class RMServerUtils {
     ...
     *
     * @param containerReleaseList containers to be released as requested by application master.
     ...
     * @throws YarnException if given application timeout value is lesser than current time.
     */
