...
public class AppSchedulingInfo {
     ...
     * @param recoverPreemptedRequestForAContainer recover ResourceRequest on preemption
     ...
     *
     * @param blacklistAdditions resources to be added to placesBlacklistedBySystem
     * @param blacklistRemovals resources to be removed from placesBlacklistedBySystem
     */
     ...
     * @param blacklistedBySystem true if it should check amBlacklist
