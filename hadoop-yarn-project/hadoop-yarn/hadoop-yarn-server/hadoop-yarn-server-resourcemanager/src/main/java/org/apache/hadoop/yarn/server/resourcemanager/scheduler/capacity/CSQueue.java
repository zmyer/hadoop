...
public interface CSQueue extends SchedulerQueue<CSQueue> {
     ...
     *
     * @return capacity of the parent of the queue as a function of the cumulative capacity in the cluster
     */
     ...
     * of the cluster.
     *
     * @return maximum-capacity of the queue as a funciton of the cumulative capacity of the cluster
     */
     ...
     * @param schedulingMode Type of exclusive check when assign container on a NodeManager, see {@link
     * SchedulingMode}.
     ...
     * @param container completed container, <code>null</code> if it was just a reservation
     * @param containerStatus <code>ContainerStatus</code> for the completed container
     ...
     * @param resourceToDec new resource asked
     */
