...
public class CapacityScheduler extends AbstractYarnScheduler<FiCaSchedulerApp, FiCaSchedulerNode> implements
    PreemptableResourceScheduler, CapacitySchedulerContext, Configurable, ResourceAllocationCommitter {
    ...
    void initScheduler(Configuration configuration) throws IOException {
        try {
            ...
            this.queueManager = new CapacitySchedulerQueueManager(yarnConf, this.labelManager);
    ...
    private void addApplicationOnRecovery(ApplicationId applicationId, String queueName, String user,
        Priority priority) {
        try {
            writeLock.lock();
    ...
    // TODO: 17/4/4 by zmyer
    private void addApplicationAttempt(ApplicationAttemptId applicationAttemptId,
        boolean transferStateFromPreviousAttempt, boolean isAttemptRecovering) {
        try {
            writeLock.lock();
            //根据提供的app id读取指定的可调度的app
    ...
    public Allocation allocate(ApplicationAttemptId applicationAttemptId,
        ...
        //更新app需要的资源信息
        LeafQueue updateDemandForQueue = updateIncreaseRequests(increaseRequests, application);
    ...
    private CSAssignment allocateContainerOnSingleNode(PlacementSet<FiCaSchedulerNode> ps,
        ...
        if (reservedContainer != null) {
            ...
            LOG.info("Trying to fulfill reservation for application " + reservedApplication
     ...
     */
    // TODO: 17/4/6 by zmyer
    private CSAssignment allocateContainersOnMultiNodes(PlacementSet<FiCaSchedulerNode> ps) {
