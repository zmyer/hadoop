...
public class CapacitySchedulerQueueManager implements SchedulerQueueManager<CSQueue, CapacitySchedulerConfiguration> {
    ...
    static final PartitionedQueueComparator PARTITIONED_QUEUE_COMPARATOR = new PartitionedQueueComparator();
     ...
     * @throws YarnException if the queue does not exist or the queue is not the type of LeafQueue.
     */
