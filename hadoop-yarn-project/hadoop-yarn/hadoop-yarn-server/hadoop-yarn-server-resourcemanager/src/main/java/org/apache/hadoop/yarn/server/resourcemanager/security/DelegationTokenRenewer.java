...
public class DelegationTokenRenewer extends AbstractService {
     ...
     * @param ts tokens
     * @param shouldCancelAtEnd true if tokens should be canceled when the app is done else false.
     * @param user user
     */
    // TODO: 17/4/3 by zmyer
     ...
     *
     * @param appIds the list of applicationIds to be kept alive.
     */
    ...
    static class AbstractDelegationTokenRenewerAppEvent extends DelegationTokenRenewerEvent {
