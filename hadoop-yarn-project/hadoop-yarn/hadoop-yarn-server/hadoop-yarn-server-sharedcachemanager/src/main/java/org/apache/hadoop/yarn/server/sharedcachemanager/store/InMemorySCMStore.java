...
public class InMemorySCMStore extends SCMStore {
     ...
     *
     * @return the filename of the newly inserted resource or that of the existing resource
     */
    @Override
     ...
     *
     * @return the collection that contains the resource references associated with the resource; or
     * an empty collection if no resource references are registered under this resource
     */
    @Override
     ...
     * later point.
     *
     * @return the access time of the resource if found; -1 if the resource is not found
     */
    @VisibleForTesting
    ...
    @Private
    @Evolving class AppCheckTask implements Runnable {
