...
public abstract class SCMStore extends CompositeService {
    ...
    @VisibleForTesting SCMStore(String name, AppChecker appChecker) {
        super(name);
     ...
     *
     * @param key a unique identifier for a resource
     * @return true if the resource was removed or did not exist, false if the resource existed,
     * contained at least one <code>SharedCacheResourceReference</code> and was not removed.
     */
    @Private
     ...
     * @return String the filename of the resource if the <code>SharedCacheResourceReference</code>
     * was added or already existed. null if the resource did not exist
     */
    @Private
     ...
     *
     * @param key a unique identifier for a resource
     * @return an unmodifiable collection of <code>SharedCacheResourceReferences</code>. If the
     * resource does not exist, an empty set is returned.
     */
    @Private
     ...
     * @param updateAccessTime true if the call should update the access time for the resource
     ...
     *
     * @param key a unique identifier for a resource
     * @param refs the collection of <code>SharedCacheResourceReference</code>s to remove
     * @param updateAccessTime true if the call should update the access time for the resource
     */
    @Private
     ...
     *
     * @param key a unique identifier for a resource
     * @param file the <code>FileStatus</code> object for the resource file in the file system.
